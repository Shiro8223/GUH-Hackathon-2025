...
export function Hero() {
  ...
  <section className="w-full bg-gradient-to-br from-brand-50 to-white py-16">
      {/* centered content */}
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-8 px-4 md:grid-cols-2">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="/events" className="btn btn-primary">Find events</a>
            <a href="/organisers" className="btn btn-ghost">Create an event</a>
          </div>
