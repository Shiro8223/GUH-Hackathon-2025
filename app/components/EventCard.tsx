...
dateISO: string;
city: string;
tags: string[]; // e.g. ["STEM", "3D-Printing"]
recommendedMajors: string[]; // majors the organiser suggests should attend
isPaid: boolean;
priceGBP?: number;
...
return (
<div className="flex flex-col justify-between rounded-2xl border border-blue-200 bg-blue-50 p-5 shadow-sm">
<div>
...
<p className="text-sm text-slate-600">{e.city} · {e.tags.join(" · ")}</p>
</div>
